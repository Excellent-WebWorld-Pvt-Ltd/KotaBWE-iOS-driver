...
let owneremailEmptyErrorString = "Please enter owner email"
let emailErrorString = "Please enter valid email"
...
let ownernumberErrorString = "Please enter owner phone number"
...
let branchCodeErrorString = "Please enter branch code"
...
let NtsaInspectionDateMissing = "Please enter NTSA inspection expiry date"
let NtsaInspectionImageMissing = "Please select NTSA inspection"

let VehicleInsuranceCertificateDateMissing = "Please enter vehicle insurance certificate expiry date"
let VehicleInsuranceCertificateImageMissing = "Please select vehicle insurance certificate"

let VehicleRegisterExpiryMissing = "Please enter vehicle register document expiry date"
let VehicleRegisterDocumentImageMissing = "Please select vehicle register document"


let VehicleLogBookMissing = "Please enter vehicle log book expiry date"
let VehicleLogBookImageMissing = "Please select vehicle log book"

let DrivingLicenseDateMissing = "Please enter driving license expiry date"
let DrivingLicenseImageMissing = "Please select driving license"

let NationalIDDateMissing = "Please enter national id number"
let NationalIDImageMissing = "Please select national id image"

let PoliceClearanceDateMissing = "Please enter police clearance expiry date"
let PoliceClearanceImageMissing = "Please select police clearance"

let DriverPSVBadgeDateMissing = "Please enter driver psv badge expiry date"
let DriverPSVBadgeImageMissing = "Please select Driver psv badge"
